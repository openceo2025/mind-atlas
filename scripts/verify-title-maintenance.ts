...
import { createTitleExcerptFromBody, hydrateMissingNodeTitlesFromBodies } from "../src/titleMaintenance.ts";
...
assert.deepEqual(result.changedNodeIds, ["empty-title", "markdown", "planet", "branch", "untitled-branch", "atlas-root"]);
