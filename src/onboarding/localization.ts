...
export const ONBOARDING_TEXT: Record<OnboardingLocale, Record<OnboardingMessageId, string>> = {
  en: {
    ...
    "space.fastZoomIn": "Zoom in quickly to enter a single child.",
  ...
  ja: {
    ...
    "space.fastZoomIn": "すばやくズームインすると、ひとつだけある子ノードへ入れます。",
    "space.nodeDrag": "ノードをゆっくりドラッグして、動かしてみましょう。",
    "space.childNode": "ノードをすばやくドラッグし、生成エフェクトが完了するまでそのまま長押ししてください。",
    ...
    "title.nameUniverse": "この宇宙に名前をつけてみましょう",
  },
};
