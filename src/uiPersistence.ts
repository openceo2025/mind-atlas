...
export type PersistedUiState = {
  ...
  mobilePanelTab?: "command" | "editor" | "operation" | "outline";
  commandDraft?: {
    value: string;
...
export function loadPersistedUiState(): PersistedUiState | null {
  ...
  try {
    ...
    return {
      ...
      mobilePanelTab: parsed.mobilePanelTab === "command" || parsed.mobilePanelTab === "editor" || parsed.mobilePanelTab === "operation" || parsed.mobilePanelTab === "outline" ? parsed.mobilePanelTab : undefined,
