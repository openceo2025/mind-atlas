...
export function RadialMenu() {
  ...
  const items: Item[] = [
    ...
    {
      key: 'reminder',
      label: t('radial.reminder'),
      icon: 'bell',
      tip: card.reminder ? t('reminder.badge', { time: formatReminderTime(card.reminder.at) }) : t('radial.reminderTip'),
      disabled: readOnly || n > 1 || card.kind === 'concept',
      run: () => openWindow('reminder', [card.id]),
    },
    {
      key: 'organize',
